...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file("mycobot_280_moveit_config", "config/nycobot.srdf")
    robot_description_semantic = {"robot_description_semantic": robot_description_semantic_config }
    
    # Kinematics.yaml file:
    kinematics_yaml = load_yaml("mycobot_280_moveit_config", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("mycobot_280_moveit_config", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml("mycobot_280_moveit_config", "config/cr35ia_controllers.yaml")
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory("mycobot_280_moveit_config"), "config")
    ...
    moveJ_interface = Node(
        ...
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": 'mycobot_arm'}],
    )
    # MoveG ACTION:
